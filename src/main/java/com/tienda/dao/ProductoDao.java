...
public interface ProductoDao extends JpaRepository<Producto, Long> { //Long es el tipo de dato
    ...
    public List<Producto> findByPrecioBetweenOrderByDescripcion(double precioInf, double precioSup);//Los orderna de forma acendente, si lo quiero decendientre le coloco el Desc findByPrecioBetweenOrderByDescripcionDesc
